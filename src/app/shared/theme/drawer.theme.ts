...
export const LV_DRAWER_OVERLAY =
  'fixed inset-0 bg-black/50  z-50 animate-fade-in';

export const LV_DRAWER_BASE =
  'fixed bg-white  shadow-2xl transition-transform duration-300 z-50';

export const LV_DRAWER_POSITIONS = {
  left: 'left-0 top-0 h-full border-r border-gray-200',
  right: 'right-0 top-0 h-full border-l border-gray-200',
  top: 'top-0 left-0 w-full border-b border-gray-200',
  bottom: 'bottom-0 left-0 w-full border-t border-gray-200',
};
