...
export const LV_NOTIFICATION_ITEM_BASE =
  'flex items-start gap-3 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg transition-all duration-300';
...
export const LV_NOTIFICATION_ITEM_CLOSE =
  'text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 transition-colors duration-200 flex-shrink-0';
