...
export const LV_SEARCH_BOX_SIZES = {
  sm: 'py-1.5 text-xs pl-8 pr-8',
  md: 'py-2 text-sm pl-10 pr-10',
  lg: 'py-2.5 text-base pl-12 pr-12',
};

export const LV_SEARCH_BOX_ICON = 'absolute left-3 text-gray-400 pointer-events-none transition-colors duration-200';
export const LV_SEARCH_BOX_ICON_SIZES = {
  sm: 'w-4 h-4',
  md: 'w-5 h-5',
  lg: 'w-6 h-6',
};
