...
export class LvAuthTemplateComponent {
  ...
  readonly classes = computed(() => {
    ...
    return {
      ...
      logo: LV_AUTH_TEMPLATE_LOGO,
      header: LV_AUTH_TEMPLATE_HEADER,
      title: LV_AUTH_TEMPLATE_TITLE,
      subtitle: LV_AUTH_TEMPLATE_SUBTITLE,
    };
  });

  getSplitClasses() {
    return {
      left: LV_AUTH_TEMPLATE_SPLIT_LEFT,
      right: LV_AUTH_TEMPLATE_SPLIT_RIGHT,
    };
  }
}
